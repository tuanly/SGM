...
namespace SGM_Core.Utils
{
    public class SGMText
    {
        ...
        public static string GASSTORE_GET_GS_ERR = "Lỗi! Không thể lấy thông tin trạm xăng.";
        public static string GASSTORE_ADD_NEW_GS_ERR = "Lỗi! Không thể thêm trạm xăng.";
        public static string GASSTORE_UPDATE_ERR = "Lỗi! Không thể cập nhật trạm xăng.";
        public static string GASSTORE_DEL_ERR = "Lỗi! Không thể xóa trạm xăng.";
        public static string GASSTORE_DEL_SUCCESS = "Trạm xăng đã xóa thành công.";
        public static string GASSTORE_DATA_INPUT_EXIST_GS_ID_ERR = "Lỗi! Mã Cây Xăng này đã tồn tại!";
        public static string GASSTORE_DATA_INPUT_GS_ID_ERR = "Lỗi! Chưa nhập Mã Cây Xăng.";
        public static string GASSTORE_DATA_INPUT_GS_NAME_ERR = "Lỗi! Chưa nhập Tên Cây Xăng.";
        public static string GASSTORE_DATA_INPUT_GS_ADDRESS_ERR = "Lỗi! Chưa nhập Địa chỉ Cây Xăng.";      
